package com.estudo.applicationworkapi
...
class ProductAdapter(private val context: Context, private val productList: List<Product>): RecyclerView.Adapter<ProductViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.prodName.text = item.prName
        holder.prodPrice.text = item.prPrice
        Glide.with(context).load(item.prImage).into(holder.prodImage)
    }
